...
public class ControlPanel extends JPanel {
	...
	//TODO añade más atributos aquí ...
	...
	private void initGUI() {
		...
		// TODO crear los diferentes botones/atributos y añadirlos a _toolaBar.
		////
		//
		//Todos ellos han de tener su correspondiente tooltip. Puedes utilizar
		//_toolaBar.addSeparator() para añadir la línea de separación vertical
		//entre las componentes que lo necesiten.
		
		//Quit Button
		_toolaBar.add(Box.createGlue()); // this aligns the button to the right _toolaBar.addSeparator();
